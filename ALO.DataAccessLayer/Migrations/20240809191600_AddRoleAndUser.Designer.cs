...
namespace ALO.DataAccessLayer.Migrations
{
    ...
    [Migration("20240809191600_AddRoleAndUser")]
            ...
            modelBuilder.Entity("ALO.DomainClasses.Entity.Account.tbl_Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTime(2024, 8, 9, 22, 45, 58, 814, DateTimeKind.Local).AddTicks(2516),
                            IsActive = true,
                            IsDelete = false,
                            RoleIndex = "0",
                            RoleName = "Admin"
            ...
            modelBuilder.Entity("ALO.DomainClasses.Entity.Account.tbl_Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDelete = false,
                            LastLogin = new DateTime(2024, 8, 9, 22, 45, 58, 814, DateTimeKind.Local).AddTicks(2551),
                            Mobile = "09121234567",
                            Password = "123456",
                            RegisteredDate = new DateTime(2024, 8, 9, 22, 45, 58, 814, DateTimeKind.Local).AddTicks(2550),
                            Registeredby = 2
                        });
                });
            ...
            modelBuilder.Entity("ALO.DomainClasses.Entity.Language.tbl_Language", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3L,
                            CreatedDate = new DateTime(2024, 8, 9, 22, 45, 58, 814, DateTimeKind.Local).AddTicks(2343),
                            IsActive = true,
                            IsDelete = false,
                            LanguageCode = "fa",
                            Name = "فارسی"
